...
rosparam set odom_topic ORB_SLAM/scaled_odom
...
echo "start gmapping"
screen -d -m -S gmapping ~/catkin_ws/src/ece592sp17-AutonomousNavigation/husky_tools/run/scripts/start-gmapping_orbodom.sh
sleep 5
